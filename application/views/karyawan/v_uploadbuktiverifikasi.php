                  ...
                  <div class="col-md-6">
                      ...
                      <div class="card card-purple">
                          <div class="card-header">
                              <h3 class="card-title">Informasi Verifikasi Perbaikan</h3>
                          </div>
                          <!-- /.card-header -->
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="card">
                          <div class="card-body">
                              ...
                              <a href="<?= base_url("karyawan/updateStatusVerifikasi/" . $jadwal['id_jadwal']); ?>" class="btn btn-success" onclick="return confirm('Apakah Anda Yakin untuk mengirim data ini ?');"><i class="fas fa-paper-plane"></i> Kirim</a>
                          </div>
                      </div>
                  </div>
                                              ...
                                              <?php $j = $totalDataPerbaikan['numrows'] ?>
                                                <?php for($b = 0; $b<$j; $b++) {
                                                  ...
                                                  <?php if ($statusPerbaikan == 'True') : ?>
                                                      <td class="text-center">
                                                          <img src="<?= base_url('assets/img/perbaikan_temuan/' . $daftarPerbaikan[$a]['foto_perbaikan']) ?>" class="rounded mx-auto d-block" style="height: 100px;" alt="Temuan Patrol">
                                                      </td>
                                                      <td>
                                                          <textarea style="min-width: 460px;" class="form-control" rows="3" disabled> <?= $daftarPerbaikan[$a]['uraian_perbaikan']; ?> </textarea>
                                                      </td>
                                                  <?php else : ?>
                                                      <td colspan="2" class="table-secondary text-center">
                                                          <b><i>Data Perbaikan Belum diisi</i></b>
                                                      </td>
                                                  <?php endif; ?>
                                                      ...
                                                      <?php if ($status == 'True') : ?>
                                                          <td class="text-center">
                                                              <a href="<?= base_url('karyawan/hapus_dataverifikasi/' . $daftarVerifikasi[$c]['id_verifikasi'] . '/' . $jadwal['id_jadwal']); ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin ingin menghapus data temuan ini ?');"><i class="far fa-trash-alt"></i></button></a>
                                                          </td>
                                                          <td class="text-center">
                                                      ...
                                                      <?php else : ?>
                                                          <td class="text-center">
                                                              <data-id_temuan= href="" data-toggle="modal" data-target="#newModalVerifikasi" class="btn btn-primary btn-sm tampilModalVerifikasi" data-id="<?= $daftarPerbaikan[$a]['id_perbaikan']; ?>" data-id_temuan="<?= $d['id_temuan']; ?>"><i class="far fa-file-alt"></i> Verifikasi Perbaikan </a>
                                                          </td>
                                                          <td class="text-center">
                                                              <i>Null</i>
                                                          </td>
  ...
  <!-- Modal -->
  <div class="modal fade" id="newModalVerifikasi" tabindex="-1" role="dialog" aria-labelledby="newModalVerifikasiLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="newModalVerifikasiLabel">Tambah Verifikasi Temuan</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              <div class="modal-body">
                  <?= form_open_multipart('karyawan/uploadBuktiVerifikasi/' . $jadwal['id_jadwal']); ?>
                  <div class="form-group">
                      <input type="hidden" name="id_temuan" id="id_temuan" value="">
                      <input type="hidden" name="id_perbaikan" id="id_perbaikan" value="">
                      <label for="exampleInputFile">Verifikasi</label>
                      <select name="verifikasi" id="verifikasi" class="form-control select2" style="width: 100%;">
                          <option value="">Verifikasi</option>
                          <option value="unclose">Unclose</option>
